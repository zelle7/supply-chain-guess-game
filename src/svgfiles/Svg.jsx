...
export function VerticalStreet() {
    return (
        <div className="cell">
            <svg className="street" height="100%" width="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none">
                <rect width="100" height="100" fill="#666464" />
...
export function FactoryItem() {
    return (
        <svg className="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none">
            ...
            <rect x="70" y="20" width="10" height="30" fill="#555" /> {/* Chimney */}
            <circle cx="75" cy="10" r="5" fill="#bbb" /> {/* Smoke */}
            <circle cx="80" cy="5" r="4" fill="#ccc" /> {/* Smoke */}
            <circle cx="85" cy="0" r="3" fill="#ddd" /> {/* Smoke */}
        </svg>
    );
}
